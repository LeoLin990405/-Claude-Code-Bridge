...
| 功能 | 描述 |
|------|------|
| **Token 统计** | 按 Provider 统计输入/输出 Token（不换算金额） |
| **CLI 预热** | 一键预热所有 AI Provider，减少首次请求延迟 |
...
| 功能 | 描述 |
|------|------|
| **赛博工业风设计** | 高级玻璃拟态效果，渐变边框 |
| **定制字体** | Outfit + JetBrains Mono 字体组合 |
| **流畅动画** | FadeUp、slideIn、pulse-glow 效果 |
| **响应式布局** | 移动端友好，自适应组件 |
