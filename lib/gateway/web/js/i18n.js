...
const i18n = {
    en: {
        ...
        // Memory v0.22 - Sub-navigation
        memorySub: 'Sessions', observations: 'Observations', system2: 'System 2', heuristic: 'Heuristic', statsTab: 'Stats',
        // Memory v0.22 - System 2
        consolidatedMemories: 'Consolidated Memories', sessionArchives: 'Session Archives',
        runConsolidation: 'Run Consolidation', applyDecay: 'Apply Decay', mergeMemories: 'Merge Similar',
        forgetMemories: 'Cleanup', consolidationStats: 'Consolidation Stats',
        totalArchives: 'Total Archives', totalConsolidated: 'Consolidated', avgImportance: 'Avg Importance',
        lastConsolidation: 'Last Run', consolidationHistory: 'Consolidation History',
        llmEnhanced: 'LLM Enhanced', learnings: 'Learnings', patterns: 'Patterns',
        hoursToConsolidate: 'Hours to Consolidate', enableLlmEnhancement: 'Enable LLM Enhancement',
        confirmConsolidation: 'This will consolidate memories from the last {hours} hours. Continue?',
        consolidationStarted: 'Consolidation started', consolidationComplete: 'Consolidation complete',
        decayApplied: 'Decay applied to {count} memories', mergeComplete: 'Merged {count} similar memories',
        forgetComplete: 'Cleaned up {count} expired memories',
        minImportanceThreshold: 'Min Importance Threshold', maxAgeDays: 'Max Age (Days)',
        // Memory v0.22 - Heuristic Retrieval
        heuristicConfig: 'Heuristic Configuration', heuristicStats: 'Heuristic Statistics',
        relevanceWeight: 'Relevance Weight (α)', importanceWeight: 'Importance Weight (β)',
        recencyWeight: 'Recency Weight (γ)', decayRate: 'Decay Rate (λ)',
        scoreFormula: 'Score = αR + βI + γT', saveConfig: 'Save Configuration',
        configSaved: 'Configuration saved', configSaveFailed: 'Failed to save configuration',
        // Memory v0.22 - Health & Stats
        memoryHealth: 'Memory Health', healthScore: 'Health Score',
        importanceDistribution: 'Importance Distribution', recencyDistribution: 'Recency Distribution',
        accessDistribution: 'Access Distribution', highImportance: 'High', mediumImportance: 'Medium',
        lowImportance: 'Low', recentMemories: 'Recent (<1h)', todayMemories: 'Today (1-24h)',
        olderMemories: 'Older (>24h)', frequentAccess: 'Frequent', moderateAccess: 'Moderate',
        rareAccess: 'Rare', retrievalPerformance: 'Retrieval Performance',
        avgQueryTime: 'Avg Query Time', cacheHitRate: 'Cache Hit Rate',
        p50Latency: 'P50 Latency', p95Latency: 'P95 Latency', p99Latency: 'P99 Latency',
        // Memory v0.22 - Settings Modal
        memorySettings: 'Memory Settings', heuristicSection: 'Heuristic Retrieval (αR + βI + γT)',
        system2Section: 'System 2 (Consolidation)', enableNightlyConsolidation: 'Enable Nightly Consolidation',
        enableLlmInsights: 'Enable LLM-Enhanced Insights', llmProvider: 'LLM Provider',
    },
    zh: {
        // Header
        ...
        noSkillsFound: '未找到技能',
        // Memory v0.22 - Sub-navigation
        memorySub: '会话', observations: '观察', system2: '系统 2', heuristic: '启发式', statsTab: '统计',
        // Memory v0.22 - System 2
        consolidatedMemories: '整合记忆', sessionArchives: '会话归档',
        runConsolidation: '运行整合', applyDecay: '应用衰减', mergeMemories: '合并相似',
        forgetMemories: '清理', consolidationStats: '整合统计',
        totalArchives: '归档总数', totalConsolidated: '已整合', avgImportance: '平均重要性',
        lastConsolidation: '上次运行', consolidationHistory: '整合历史',
        llmEnhanced: 'LLM 增强', learnings: '学习点', patterns: '模式',
        hoursToConsolidate: '整合小时数', enableLlmEnhancement: '启用 LLM 增强',
        confirmConsolidation: '将整合最近 {hours} 小时的记忆。是否继续？',
        consolidationStarted: '整合已开始', consolidationComplete: '整合完成',
        decayApplied: '已对 {count} 条记忆应用衰减', mergeComplete: '已合并 {count} 条相似记忆',
        forgetComplete: '已清理 {count} 条过期记忆',
        minImportanceThreshold: '最低重要性阈值', maxAgeDays: '最大天数',
        // Memory v0.22 - Heuristic Retrieval
        heuristicConfig: '启发式配置', heuristicStats: '启发式统计',
        relevanceWeight: '相关性权重 (α)', importanceWeight: '重要性权重 (β)',
        recencyWeight: '新近度权重 (γ)', decayRate: '衰减率 (λ)',
        scoreFormula: '评分 = αR + βI + γT', saveConfig: '保存配置',
        configSaved: '配置已保存', configSaveFailed: '保存配置失败',
        // Memory v0.22 - Health & Stats
        memoryHealth: '记忆健康度', healthScore: '健康评分',
        importanceDistribution: '重要性分布', recencyDistribution: '新近度分布',
        accessDistribution: '访问分布', highImportance: '高', mediumImportance: '中',
        lowImportance: '低', recentMemories: '最近 (<1h)', todayMemories: '今日 (1-24h)',
        olderMemories: '较早 (>24h)', frequentAccess: '频繁', moderateAccess: '适中',
        rareAccess: '稀少', retrievalPerformance: '检索性能',
        avgQueryTime: '平均查询时间', cacheHitRate: '缓存命中率',
        p50Latency: 'P50 延迟', p95Latency: 'P95 延迟', p99Latency: 'P99 延迟',
        // Memory v0.22 - Settings Modal
        memorySettings: '记忆设置', heuristicSection: '启发式检索 (αR + βI + γT)',
        system2Section: '系统 2 (整合)', enableNightlyConsolidation: '启用夜间整合',
        enableLlmInsights: '启用 LLM 增强洞察', llmProvider: 'LLM 提供者',
    }
};
