# HiveMind Code Review Style Guide

## Overview

This document defines the coding standards and best practices for the HiveMind project. The AI code reviewer should use these guidelines when reviewing pull requests.
