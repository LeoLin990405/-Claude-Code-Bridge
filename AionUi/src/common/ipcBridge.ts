...
// Hivemind helpers (currently uses the unified conversation send/stop/stream)
export const hivemindConversation = {
  sendMessage: conversation.sendMessage,
  responseStream: conversation.responseStream,
};
...
export interface ICreateConversationParams {
  ...
  extra: {
    ...
    /** Hivemind gateway base URL */
    gatewayUrl?: string;
    /** Hivemind default provider, null = auto route */
    defaultProvider?: string | null;
    /** Hivemind request timeout in seconds */
    timeoutS?: number;
    /** Hivemind streaming flag */
    streaming?: boolean;
    /** Hivemind agent role for memory injection */
    agent?: string | null;
    /** Hivemind cache bypass */
    cacheBypass?: boolean;
    /** Hivemind system prompt */
