...
import { createAcpAgent, createCodexAgent, createGeminiAgent, createHivemindAgent, createOpenClawAgent } from '../initAgent';
  ...
  static async createConversation(params: ICreateConversationOptions): Promise<ICreateConversationResult> {
    ...
    try {
      ...
      if (type === 'gemini') {
        ...
        conversation = await createHivemindAgent(params);
      } else {
