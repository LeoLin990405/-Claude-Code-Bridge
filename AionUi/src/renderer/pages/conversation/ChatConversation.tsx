...
import HivemindChat from './hivemind/HivemindChat';
...
const ChatConversation: React.FC<{
  ...
  const conversationNode = useMemo(() => {
    ...
    switch (conversation.type) {
      ...
      case 'hivemind':
        return <HivemindChat key={conversation.id} conversation_id={conversation.id} workspace={conversation.extra?.workspace} />;
      default:
        return null;
    }
