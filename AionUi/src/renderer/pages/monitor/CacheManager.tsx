    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-semibold">
          {t('monitor.cache.title', { defaultValue: 'Cache Management' })}
        </h1>
      ...
      <div className="grid grid-cols-4 gap-4">
        <Card>
          <CardContent className="pt-6">
            <Statistic 
              title={t('monitor.cache.totalEntries', { defaultValue: 'Total Entries' })} 
        ...
        <Card>
          <CardContent className="pt-6">
            <Statistic 
              title={t('monitor.cache.totalHits', { defaultValue: 'Total Hits' })} 
        ...
        <Card>
          <CardContent className="pt-6">
            <Statistic 
              title={t('monitor.cache.totalMisses', { defaultValue: 'Total Misses' })} 
              value={cacheStats?.total_misses || 0} 
            />
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base">
            {t('monitor.cache.description', { defaultValue: 'Cache Information' })}
          </CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <Dialog open={showConfirmDialog} onOpenChange={setShowConfirmDialog}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>
              {t('monitor.cache.clearConfirmTitle', { defaultValue: 'Clear Cache?' })}
            </DialogTitle>
            <DialogDescription>
