...
interface EventTypes {
  ...
  'hivemind.selected.file': [Array<string | FileOrFolderItem>];
  'hivemind.selected.file.append': [Array<string | FileOrFolderItem>];
  'hivemind.selected.file.clear': void;
  'hivemind.workspace.refresh': void;
  'hivemind.regenerate': void;
